...
import RecommendationEnt from '@/views/pages/RecommendationEnt'
...
export default {
  ...
  data() {
    return {
      list: [
        {path:'/RecommendationEnt',component:RecommendationEnt},
      ...
      arr: ['/RecommendationEnt','/JueDiQiuSheng','/Lol','/ErCiYuan','/XingXiu','/ChiHeWanLe','/HuWai']
    }
  },
  mounted() {
    var that = this
